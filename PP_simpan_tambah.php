...
$mysqli="INSERT INTO guestbook (posted, nama, email, address, city, message) VALUES ('$posted','$nama', '$email', '$address', '$city', '$message')";
$result=mysqli_query ($conn, $mysqli);

if($result){
    echo "<script>alert('Data guestBook berhasil ditambahkan')</script>";
}else{
    echo "<script>alert('Data guestBook gagal ditambahkan')</script>";
}
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <h2 class="alert alert-danger text-center mt-3">TAMBAH GUESTBOOK</h2>
